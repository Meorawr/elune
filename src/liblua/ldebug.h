...
LUAI_FUNC LUA_NORETURN void luaG_typeerror (lua_State *L, const TValue *o,
                                            const char *opname);
LUAI_FUNC LUA_NORETURN void luaG_concaterror (lua_State *L, StkId p1, StkId p2);
LUAI_FUNC LUA_NORETURN void luaG_aritherror (lua_State *L, const TValue *p1,
                                             const TValue *p2);
LUAI_FUNC LUA_NORETURN void luaG_ordererror (lua_State *L, const TValue *p1,
                                             const TValue *p2);
...
LUAI_FUNC int luaG_getinfo (lua_State *L, CallInfo *ci, const char *what,
                            lua_Debug *ar);
