...
static inline void setobj2n (lua_State *L, TValue *dst, const TValue *src) { setobj(L, dst, src); }
static inline void setobj2t (lua_State *L, TValue *dst, const TValue *src) { setobj(L, dst, src); }
static inline void setobjs2s (lua_State *L, StkId dst, const TValue *src) { setobj2s(L, dst, src); }
static inline void setobjt2t (lua_State *L, TValue *dst, const TValue *src) { setobj(L, dst, src); }

static inline void sethvalue2s (lua_State *L, StkId dst, Table *src) { sethvalue(L, dst, src); }
static inline void setptvalue2s (lua_State *L, StkId dst, Proto *src) { setptvalue(L, dst, src); }
static inline void setsvalue2n (lua_State *L, TValue *dst, TString *src) { setsvalue(L, dst, src); }
static inline void setsvalue2s (lua_State *L, StkId dst, TString *src) { setsvalue(L, dst, src); }
static inline void setnilvalue2t (TValue *dst) { dst->tt = LUA_TNIL; dst->taint = NULL; }
